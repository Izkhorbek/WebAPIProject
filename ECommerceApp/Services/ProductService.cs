...
namespace ECommerceApp.Services
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(ECommerceAppDbContext dbContext) => _dbContext = dbContext;
        ...
        public async Task<ApiResponse<ProductResponseDTO>> CreateProductAsync(ProductCreateDTO productDto)
        {
            ...
            try
            {
                ...
                if(await _dbContext.Products.AnyAsync(p => p.Name.ToLower() == productDto.Name.ToLower()))
                {
                    return new ApiResponse<ProductResponseDTO>(400, "Product name already exist.");
                }
        ...
        public async Task<ApiResponse<ConfirmationResponseDTO>> UpdateProductAsync(ProductUpdateDTO productDto)
        {
            try
            {
                ...
                if (await _dbContext.Products.AnyAsync(p => p.Name.ToLower() == productDto.Name.ToLower() && p.Id != productDto.Id))
                {
